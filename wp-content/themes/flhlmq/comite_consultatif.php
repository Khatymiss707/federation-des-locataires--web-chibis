...
<div class="service_comite">
			...
			<?php the_content(); ?>
                ...
                <a class="document_association"
				href="<?php the_field('link_url_1'); ?>">
				<?php the_field('link_title_1'); ?>
				</a>
			
			</br></br>

			<a class="document_agir"
				href="<?php the_field('link_url_2'); ?>">
			...
			<a href="<?php the_field('title'); ?>">
                ...
                <h3 class="service_suivant_infolettre_titre">
                    <?php the_field('next_news.description_title'); ?>
                </h3>
                <p class="service_suivant_infolettre_para">
				    <?php the_field('next_news.description_next_news'); ?>
                </p>
